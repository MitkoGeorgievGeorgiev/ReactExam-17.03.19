            ...
            {!this.state.post
                ...
                <div className="card text-center">
                    ...
                    <div className="card-body">
                        ...
                        <p className="card-text">{this.state.post.price} BGN</p>
                        ...
                        {this.props.isAdmin
                            ? <div><Link to={`/post/update/${this.props.match.params.id}`} className="blue">Редактирай</Link>
                                <Link to={`/post/delete/${this.props.match.params.id}`} className="red">Изтрий</Link></div>
                            : null}
                    </div>
